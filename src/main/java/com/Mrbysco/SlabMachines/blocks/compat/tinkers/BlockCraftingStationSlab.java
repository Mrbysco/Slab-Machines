...
public class BlockCraftingStationSlab extends BlockSlab implements ITinkerStationBlock {
	public static final PropertyEnum<BlockCraftingStationSlab.Variant> VARIANT = PropertyEnum.<BlockCraftingStationSlab.Variant>create("variant", BlockCraftingStationSlab.Variant.class);
    ...
    public BlockCraftingStationSlab() {
		super(Material.WOOD);
		
		this.setUnlocalizedName(SlabReference.MOD_PREFIX + "crafting_station_slab".replaceAll("_", ""));
		this.setRegistryName("crafting_station_slab");
		this.setHardness(2.0F);
		this.setResistance(5.0F);
	    this.setSoundType(SoundType.WOOD);
		useNeighborBrightness = true;
		setCreativeTab(SlabMachines.slabTab);
		setDefaultState(blockState.getBaseState().withProperty(VARIANT, BlockCraftingStationSlab.Variant.DEFAULT)
			.withProperty(HALF, EnumBlockHalf.BOTTOM)
			.withProperty(FACING, EnumFacing.NORTH)
			.withProperty(BlockToolTable.TABLES, BlockToolTable.TableTypes.CraftingStation));
	...
	public Comparable<?> getTypeForItem(ItemStack stack) {
        return BlockCraftingStationSlab.Variant.DEFAULT;
	}
    ...
    {
	    return new ExtendedBlockState(this, new IProperty[] {VARIANT, HALF, FACING, BlockToolTable.TABLES}, new IUnlistedProperty[]{INVENTORY});
	}
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer,
	    ...
	    TileCraftingStationSlab te = SlabUtil.getTileSlab(worldIn, pos, state.getValue(HALF), TileCraftingStationSlab.class);
	...
	public boolean openGui(EntityPlayer player, World world, BlockPos pos) {
		int id = world.getBlockState(pos).getValue(HALF) == EnumBlockHalf.TOP ? SlabGuiHandler.GUI_CRAFTINGSTATION_SLAB_TOP : SlabGuiHandler.GUI_CRAFTINGSTATION_SLAB_BOTTOM;
	...
	public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileCraftingStationSlab();
	}
	...
	public IBlockState getExtendedState(IBlockState state, IBlockAccess world, BlockPos pos) {
	    ...
	    TileCraftingStationSlab te = SlabUtil.getTileSlab(world, pos, state.getValue(HALF), TileCraftingStationSlab.class);
	    if(te != null) 
	    {
	...
	public boolean rotateBlock(World world, BlockPos pos, EnumFacing axis) {
	    TileCraftingStationSlab table = SlabUtil.getTileSlab(world, pos, world.getBlockState(pos).getValue(HALF), TileCraftingStationSlab.class);
	    if(table != null) {
