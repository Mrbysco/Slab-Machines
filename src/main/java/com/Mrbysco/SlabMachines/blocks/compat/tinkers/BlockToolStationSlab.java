...
public class BlockToolStationSlab extends BlockSlab implements ITinkerStationBlock {
	public static final PropertyEnum<BlockToolStationSlab.Variant> VARIANT = PropertyEnum.<BlockToolStationSlab.Variant>create("variant", BlockToolStationSlab.Variant.class);
    ...
    public BlockToolStationSlab() {
		...
		this.setUnlocalizedName(SlabReference.MOD_PREFIX + "tool_station_slab".replaceAll("_", ""));
		this.setRegistryName("tool_station_slab");
		this.setHardness(2.0F);
		this.setResistance(5.0F);
	    this.setSoundType(SoundType.WOOD);
		useNeighborBrightness = true;
		setCreativeTab(SlabMachines.slabTab);
		setDefaultState(blockState.getBaseState().withProperty(VARIANT, BlockToolStationSlab.Variant.DEFAULT).withProperty(HALF, EnumBlockHalf.BOTTOM).withProperty(FACING, EnumFacing.NORTH));
	...
	public Comparable<?> getTypeForItem(ItemStack stack) {
        return BlockToolStationSlab.Variant.DEFAULT;
	}
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer,
		...
		TileToolStationSlab te = SlabUtil.getTileSlab(worldIn, pos, state.getValue(HALF), TileToolStationSlab.class);
	...
	public boolean openGui(EntityPlayer player, World world, BlockPos pos) {
		int id = world.getBlockState(pos).getValue(HALF) == EnumBlockHalf.TOP ? SlabGuiHandler.GUI_TOOLSTATION_SLAB_TOP : SlabGuiHandler.GUI_TOOLSTATION_SLAB_BOTTOM;
	...
	public IBlockState getExtendedState(IBlockState state, IBlockAccess world, BlockPos pos) {
		...
		TileToolStationSlab te = SlabUtil.getTileSlab(world, pos, state.getValue(HALF), TileToolStationSlab.class);
	    if(te != null) 
	    {
	...
	public boolean rotateBlock(World world, BlockPos pos, EnumFacing axis) {
		TileToolStationSlab table = SlabUtil.getTileSlab(world, pos, world.getBlockState(pos).getValue(HALF), TileToolStationSlab.class);
	    if(table != null) {
