...
public class GuiChestSlab extends GuiContainer
{
    ...
    public GuiChestSlab(IInventory upperInv, IInventory lowerInv)
    {
        super(new ContainerChestSlab(upperInv, lowerInv, Minecraft.getMinecraft().player));
