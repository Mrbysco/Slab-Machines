...
public class BlockToolForgeSlab extends BlockSlab implements ITinkerStationBlock {
	public static final PropertyEnum<BlockToolForgeSlab.Variant> VARIANT = PropertyEnum.<BlockToolForgeSlab.Variant>create("variant", BlockToolForgeSlab.Variant.class);
    ...
    public BlockToolForgeSlab() {
    	super(Material.IRON);
		
		this.setUnlocalizedName(SlabReference.MOD_PREFIX + "tool_forge_slab".replaceAll("_", ""));
		this.setRegistryName("tool_forge_slab");
		this.setHardness(2.0F);
	    this.setResistance(10f);
	    this.setSoundType(SoundType.METAL);
		useNeighborBrightness = true;
		setCreativeTab(SlabMachines.slabTab);
		setDefaultState(blockState.getBaseState().withProperty(VARIANT, BlockToolForgeSlab.Variant.DEFAULT).withProperty(HALF, EnumBlockHalf.BOTTOM).withProperty(FACING, EnumFacing.NORTH));
	...
	public Comparable<?> getTypeForItem(ItemStack stack) {
        return BlockToolForgeSlab.Variant.DEFAULT;
	}
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer,
		...
		TileToolForgeSlab te = SlabUtil.getTileSlab(worldIn, pos, state.getValue(HALF), TileToolForgeSlab.class);
	...
	public boolean openGui(EntityPlayer player, World world, BlockPos pos) {
		int id = world.getBlockState(pos).getValue(HALF) == EnumBlockHalf.TOP ? SlabGuiHandler.GUI_TOOLFORGE_SLAB_TOP : SlabGuiHandler.GUI_TOOLFORGE_SLAB_BOTTOM;
	...
	public IBlockState getExtendedState(IBlockState state, IBlockAccess world, BlockPos pos) {
		...
		TileToolForgeSlab te = SlabUtil.getTileSlab(world, pos, state.getValue(HALF), TileToolForgeSlab.class);
	    if(te != null) 
	    {
	...
	public boolean rotateBlock(World world, BlockPos pos, EnumFacing axis) {
		TileToolForgeSlab table = SlabUtil.getTileSlab(world, pos, world.getBlockState(pos).getValue(HALF), TileToolForgeSlab.class);
	    if(table != null) {
