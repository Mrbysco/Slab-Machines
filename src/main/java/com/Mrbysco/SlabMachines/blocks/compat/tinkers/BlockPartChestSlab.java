...
public class BlockPartChestSlab extends BlockSlab implements ITinkerStationBlock {
	public static final PropertyEnum<BlockPartChestSlab.Variant> VARIANT = PropertyEnum.<BlockPartChestSlab.Variant>create("variant", BlockPartChestSlab.Variant.class);
    ...
    public BlockPartChestSlab() {
		...
		this.setUnlocalizedName(SlabReference.MOD_PREFIX + "part_chest_slab".replaceAll("_", ""));
		...
		setDefaultState(blockState.getBaseState().withProperty(VARIANT, BlockPartChestSlab.Variant.DEFAULT).withProperty(HALF, EnumBlockHalf.BOTTOM).withProperty(FACING, EnumFacing.NORTH));
	...
	public Comparable<?> getTypeForItem(ItemStack stack) {
        return BlockPartChestSlab.Variant.DEFAULT;
	}
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer,
		...
		TilePartChestSlab te = SlabUtil.getTileSlab(worldIn, pos, state.getValue(HALF), TilePartChestSlab.class);
	...
	public boolean openGui(EntityPlayer player, World world, BlockPos pos) {
		int id = world.getBlockState(pos).getValue(HALF) == EnumBlockHalf.TOP ? SlabGuiHandler.GUI_PARTCHEST_SLAB_TOP : SlabGuiHandler.GUI_PARTCHEST_SLAB_BOTTOM;
	...
	public boolean rotateBlock(World world, BlockPos pos, EnumFacing axis) {
		TilePartChestSlab table = SlabUtil.getTileSlab(world, pos, world.getBlockState(pos).getValue(HALF), TilePartChestSlab.class);
	    if(table != null) {
	...
	private void writeDataOntoItemstack(@Nonnull ItemStack item, @Nonnull IBlockAccess world, @Nonnull BlockPos pos, @Nonnull IBlockState state, boolean inventorySave) {
		...
		TilePartChestSlab te = SlabUtil.getTileSlab(world, pos, state.getValue(HALF), TilePartChestSlab.class);
	    if(te != null) {
