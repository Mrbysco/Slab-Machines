...
public class BlockStencilTableSlab extends BlockSlab implements ITinkerStationBlock {
    ...
    public BlockStencilTableSlab() {
		super(Material.WOOD);
		
		this.setUnlocalizedName(SlabReference.MOD_PREFIX + "stencil_table_slab".replaceAll("_", ""));
		this.setRegistryName("stencil_table_slab");
		this.setHardness(2.0F);
		this.setResistance(5.0F);
	    this.setSoundType(SoundType.WOOD);
		useNeighborBrightness = true;
		setCreativeTab(SlabMachines.slabTab);
		setDefaultState(blockState.getBaseState().withProperty(VARIANT, BlockStencilTableSlab.Variant.DEFAULT).withProperty(HALF, EnumBlockHalf.BOTTOM).withProperty(FACING, EnumFacing.NORTH));
	...
	public Comparable<?> getTypeForItem(ItemStack stack) {
        return BlockStencilTableSlab.Variant.DEFAULT;
	}
	...
	public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer,
		...
		TileStencilTableSlab te = SlabUtil.getTileSlab(worldIn, pos, state.getValue(HALF), TileStencilTableSlab.class);
	...
	public boolean openGui(EntityPlayer player, World world, BlockPos pos) {
		int id = world.getBlockState(pos).getValue(HALF) == EnumBlockHalf.TOP ? SlabGuiHandler.GUI_STENCILTABLE_SLAB_TOP : SlabGuiHandler.GUI_STENCILTABLE_SLAB_BOTTOM;
	...
	public TileEntity createTileEntity(World world, IBlockState state) {
        return new TileStencilTableSlab();
	}
	...
	public boolean rotateBlock(World world, BlockPos pos, EnumFacing axis) {
		TileStencilTableSlab table = SlabUtil.getTileSlab(world, pos, world.getBlockState(pos).getValue(HALF), TileStencilTableSlab.class);
	    if(table != null) {
	...
	private void writeDataOntoItemstack(@Nonnull ItemStack item, @Nonnull IBlockAccess world, @Nonnull BlockPos pos, @Nonnull IBlockState state, boolean inventorySave) {
		...
		TileStencilTableSlab te = SlabUtil.getTileSlab(world, pos, state.getValue(HALF), TileStencilTableSlab.class);
	    if(te != null) {
